...
!function(t, e) {
    ...
    var i = {}
      , r = /([a-z\d])([A-Z])/g;
    function d(t) {
        return t in i || (i[t] = t.replace(r, "$1-$2").toLowerCase()),
        i[t]
    }
    var o = /-(\w)/g;
    function f(t) {
    ...
    function W(t) {
        return _(t) || E(t) || C(t) ? t : M(t) || A(t) ? t[0] : $(t) ? W(t[0]) : null
    }
    function V(t) {
        return _(t) ? [t] : M(t) ? g.slice.call(t) : $(t) ? t.map(W).filter(Boolean) : A(t) ? t.toArray() : []
    }
    function R(t) {
    ...
    function dt(t, s, e) {
        ...
        t = function(t) {
            ...
            return n ? (n.id || (n.id = "uk-" + Date.now() + e,
            a.push(function() {
                return ot(n, "id")
            })),
            "#" + It(n.id) + " " + t) : null
    ...
    function xt(t, e) {
        ...
        _(t) ? yt.call(t, e) : V(t).map(function(t) {
            return xt(t, e)
        }).filter(Boolean)
    }
    function kt(t, e) {
        var n = [];
        for (t = W(t); t = t.parentElement; )
            bt(t, e) && n.push(t);
        return n
    }
    ...
    function Nt(t, e) {
        return D(e) ? bt(t, e) || xt(t, e) : t === e || (C(e) ? e.documentElement : W(e)).contains(W(t))
    }
    function Mt() {
    ...
    function ue(t, e, n, i) {
        ...
        void 0 === i && (i = !1);
        var r = (e = V(e)).length;
        return t = B(t) ? F(t) : "next" === t ? n + 1 : "previous" === t ? n - 1 : ce(e, t),
        i ? Z(t, 0, r - 1) : (t %= r) < 0 ? t + r : t
    }
    function le(t) {
        return (t = Se(t)).innerHTML = "",
        t
    }
    function de(t, e) {
        return t = Se(t),
    ...
    function $e(t) {
        ...
        return xe.test(t) ? n.insertAdjacentHTML("beforeend", t.trim()) : n.textContent = t,
        ...
        if (i.length) {
            ...
            V(t).forEach(function(t) {
                for (var e = t.classList, n = 0; n < i.length; n++)
                    Be.Force ? e.toggle.apply(e, [i[n]].concat(r)) : e[(H(r) ? !e.contains(i[n]) : r) ? "add" : "remove"](i[n])
            })
        }
    }
    function De(t, n, i) {
    ...
    function He(t, e, r) {
        return V(t).map(function(n) {
            if (D(e)) {
                ...
                H(r))
                    return Fe(n, e);
                r || z(r) ? n.style[e] = B(r) && !Pe[e] ? r + "px" : r : n.style.removeProperty(e)
            } else {
                if ($(e)) {
                    var i = Le(n);
    ...
    function We(t) {
        ...
        if (!Jt)
            return Le(e).getPropertyValue("--uk-" + t);
        if (!(t in je)) {
            var n = fe(e, document.createElement("div"));
            Ce(n, "uk-" + t),
            je[t] = Fe(n, "content", ":before").replace(/^["'](.*)["']$/, "$1"),
            ve(n)
        }
        return je[t]
    }
        ...
        Rt.all(V(t).map(function(s) {
            return new Rt(function(i, r) {
                if (Me(s, Ke))
                    ...
                    w(e, Xe) && (a && (t += " uk-transform-origin-" + a),
                    h && (t += " " + Xe + "reverse")),
                    o(),
                    Dt(s, "animationend animationcancel", function(t) {
                        var e = t.type
                          , n = !1;
                        "animationcancel" === e ? (r(),
                        o()) : (i(),
    ...
    function nn(t) {
        var e, n, i = bn(t = W(t)), r = i.pageYOffset, o = i.pageXOffset;
        if (E(t)) {
            var s = t.innerHeight
              , a = t.innerWidth;
            return {
        ...
        Et(t) || "none" !== He(t, "display") || (e = it(t, "style"),
        n = it(t, "hidden"),
        it(t, {
    ...
    function rn(i) {
        var r = (i = W(i)).offsetParent || function(t) {
          ...
          , t = ["top", "left"].reduce(function(t, e) {
            var n = p(e);
            return t[e] -= o[e] + j(He(i, "margin" + n)) + j(He(r, "border" + n + "Width")),
            t
        }, en(i));
        return {
            top: t.top,
    ...
    function hn(t, n, e) {
        ...
        He(n, "boxSizing") === e ? Qe[t].slice(1).map(p).reduce(function(t, e) {
    ...
    function vn(t, e, n) {
        ...
        void 0 === n && (n = window),
        B(t) ? +t : u(t, "vh") ? wn(on(bn(n)), t) : u(t, "vw") ? wn(sn(bn(n)), t) : u(t, "%") ? wn(nn(n)[e], t) : j(t)
    }
    function wn(t, e) {
        return t * j(e) / 100
    }
    ...
    Tn.prototype = {
        ...
        init: function() {
            ...
            this.unbind = Mt(document, "mousemove", function(n) {
                r || (setTimeout(function() {
                    ...
                    e && 100 < t - i.positions[e - 1].time && i.positions.splice(0, e),
                    i.positions.push({
                        time: t,
                        x: n.pageX,
                        y: n.pageY
        ...
        movesTo: function(t) {
            ...
            return e.right <= n.x || (e.left >= n.x ? (r[0].reverse(),
            r[1].reverse()) : e.bottom <= n.y ? r[0].reverse() : e.top >= n.y && r[1].reverse()),
    ...
    function Mn(t, e) {
        ...
        void 0 === e && (e = []);
        try {
            return t ? w(t, "{") ? JSON.parse(t) : e.length && !y(t, ":") ? ((n = {})[e[0]] = t,
    ...
    On.prototype.enableApi = function() {
        ...
        if (this.ready)
            return this.ready;
        var n, i = this.isYoutube(), r = this.isVimeo();
        return i || r ? this.ready = new Rt(function(t) {
    ...
    function Jn(e, n, i) {
        ...
        e._events.push(Mt(r, t, h ? D(h) ? h : h.call(e) : null, o, O(a) ? {
            passive: a,
            capture: s
        } : s)))
    }
    ...
    function Qn(t, e) {
        return t === Boolean ? L(e) : t === Number ? F(e) : "list" === t ? R(e) : t ? t(e) : e
    }
    ...
    Ln.mixin = function(t, e) {
        (e = (D(e) ? Ln.component(e) : e) || this).options = Nn(e.options, t)
    }
    ,
    Ln.extend = function(t) {
        ...
        return t = t || {},
        ((e.prototype = Object.create(this.prototype)).constructor = e).options = Nn(this.options, t),
        e.super = this,
    ...
    Ln.update = function(t, e) {
        (function t(e, n) {
            e && e !== document.body && e.parentNode && (t(e.parentNode, n),
            n(e.parentNode))
        }
    ...
    (Vn = Hn).prototype._init = function(t) {
        (t = t || {}).data = function(t, e) {
            ...
            e.args)
              , r = e.props;
            if (void 0 === r && (r = {}),
            n = $(n) ? P(i) ? void 0 : n.slice(0, i.length).reduce(function(t, e, n) {
                return T(e) ? X(t, e) : t[i[n]] = e,
                t
            }, {}) : n)
                for (var o in n)
    ...
    Vn.prototype._callWatches = function() {
        ...
        for (var n in e) {
            var i = e[n];
            delete e[n],
            t[n].watch && !q(i, this[n]) && t[n].watch.call(this, this[n], i)
        }
    }
    ,
    ...
    Yn.component = function(s, t) {
        if (!t)
            return T(Un[s]) && (Un[s] = Yn.extend(Un[s])),
            Un[s];
        Yn[s] = function(t, n) {
        ...
        methods: {
            toggleElement: function(c, u, l) {
                ...
                return new Rt(function(t) {
                    c = V(c);
                    function e(t) {
                        return Rt.all(t.map(function(t) {
            ...
            toggleNow: function(e, n) {
                var i = this;
                return new Rt(function(t) {
                    return Rt.all(V(e).map(function(t) {
            ...
            _toggleElement: function(t, e, n) {
                var i = this;
                if (e = O(e) ? e : Ze.inProgress(t) ? Me(t, "uk-animation-leave") : Ue.inProgress(t) ? "0px" === t.style.height : !this.isToggled(t),
                ...
                var r = (I(n) ? n : !1 !== n && this.hasAnimation ? this.hasTransition ? function(t) {
                    ...
                    return function(t, e) {
                        return Ze.cancel(t),
                        e ? (o(t, !0),
                        Ze.in(t, n[0], i, r)) : Ze.out(t, n[1] || n[0], i, r).then(function() {
                            return o(t, !1)
                        })
                    }
            ...
            _toggle: function(t, e) {
                var n;
                t && (e = Boolean(e),
                this.cls ? (n = y(this.cls, " ") || e !== Me(t, this.cls)) && Oe(t, this.cls, y(this.cls, " ") ? void 0 : e) : (n = e === rt(t, "hidden")) && it(t, "hidden", e ? null : ""),
    ...
    var ni = {
        ...
        events: [{
            ...
            handler: function(t) {
                t.preventDefault(),
                this.toggle(ce(Te(this.targets + " " + this.$props.toggle, this.$el), t.current))
            }
        }],
        connected: function() {
            if (!1 !== this.active) {
            ...
            toggle: function(r, o) {
                ...
                (r = this.items[t]) && [r].concat(!this.multiple && !y(a, r) && a || []).forEach(function(t) {
                    ...
                    if (n || !e || s.collapsible || !(a.length < 2)) {
                        ...
                        t._wrapper || (t._wrapper = we(i, "<div>"),
                        it(t._wrapper, "hidden", n ? "" : null)),
                        s._toggle(i, !0),
                        s.toggleElement(t._wrapper, n, o).then(function() {
                            Me(t, s.clsOpen) === n && (n || s._toggle(i, !1),
                            t._wrapper = null,
                            ye(i))
                        })
                    }
    ...
    var oi, si, ai = {
        ...
        connected: function() {
            this.inView && !rt(this.$el, "preload") && (this.$el.preload = "none"),
        ...
        methods: {
            positionAt: function(t, e, n) {
                ...
                var r = this.offset
                  , o = this.getAxis();
                B(r) || (r = (i = Se(r)) ? en(i)["x" === o ? "left" : "top"] - en(e)["x" === o ? "right" : "bottom"] : 0);
                ...
                this.dir = "x" === o ? a : h,
                this.align = "x" === o ? h : a,
                Oe(t, this.clsPos + "-" + this.dir + "-" + this.align, !1 === this.offset)
            },
            getAxis: function() {
        ...
        events: [{
            ...
            handler: function(t) {
                jt(t) || (oi && oi !== this && oi.toggle && y(oi.toggle.mode, "hover") && !Nt(t.target, oi.toggle.$el) && !et({
                    x: t.pageX,
                    y: t.pageY
                }, en(oi.$el)) && oi.hide(!1),
                t.preventDefault(),
                ...
                function() {
                    ...
                    Mt(document, re, function(t) {
                        ...
                        if (!t.defaultPrevented)
                            for (; oi && oi !== e && !Nt(n, oi.$el) && (!oi.toggle || !Nt(n, oi.toggle.$el)); )
                                (e = oi).hide(!1)
                    })
                }()
            }
            ...
            handler: function(t) {
                var e = t.target;
                this.$el === e ? (oi = this.isActive() ? null : oi,
                zt(this.$el, "updatearia"),
                this.tracker.cancel()) : oi = null === oi && Nt(e, this.$el) && this.isToggled() ? this : oi
            }
        }, {
            name: "updatearia",
            self: !0,
            handler: function(t, e) {
                ...
                (e || this.toggle) && (it((e || this.toggle).$el, "aria-expanded", this.isToggled() ? "true" : "false"),
                Oe(this.toggle.$el, this.cls, this.isToggled()))
            }
        }],
        update: {
            write: function() {
        ...
        methods: {
                    ...
                    !i.isActive())
                        if (n && oi && oi !== i && oi.isDelaying)
                            ...
                            if (i.isParentOf(oi)) {
                                ...
                                for (var t; oi && oi !== t && !i.isChildOf(oi); )
                                    (t = oi).hide(!1);
                            n && i.delayShow ? i.showTimer = setTimeout(r, i.delayShow) : r(),
                            oi = i
                        }
                }
                e && this.toggle && e.$el !== this.toggle.$el ? (Dt(this.$el, "hide", t),
                this.hide(!1)) : t()
            },
            hide: function(t) {
                var e = this;
            ...
            position: function() {
                ...
                if ("justify" === this.align) {
                    ...
                    this.$el.offsetWidth > Math.max(t.right - e.left, e.right - t.left) && Ce(this.$el, this.clsDrop + "-stack");
      ...
      , di = {
        ...
        update: function() {
            var t = this.target
              , e = this.input;
            if (t) {
                var n, i = At(t) ? "value" : "textContent", r = t[i], o = e.files && e.files[0] ? e.files[0].name : bt(e, "select") && (n = Te("option", e).filter(function(t) {
                    return t.selected
        ...
        for (var e = [[]], n = 0; n < t.length; n++) {
            ...
            if (r.height)
                for (var o = e.length - 1; 0 <= o; o--) {
                    ...
                    var a = void 0;
                    if (a = s[0].offsetParent === i.offsetParent ? gi(s[0]) : (r = gi(i, !0),
                    gi(s[0], !0)),
        ...
        update: {
            read: function(t) {
                ...
                if (this.expand) {
                    ...
                    !0 === this.offsetBottom ? n += " - " + $i(this.$el.nextElementSibling) + "px" : B(this.offsetBottom) ? n += " - " + this.offsetBottom + "vh" : this.offsetBottom && u(this.offsetBottom, "px") ? n += " - " + j(this.offsetBottom) + "px" : D(this.offsetBottom) && (n += " - " + $i(at(this.offsetBottom, this.$el)) + "px"),
                    n += (i ? " - " + i + "px" : "") + ")"
                }
                return {
                    minHeight: n,
            ...
            write: function(t) {
                if (this.dataSrcset && 1 !== window.devicePixelRatio) {
                    ...
                    !e.match(/^(auto\s?)+$/) && j(e) !== t.bgSize || (t.bgSize = function(t, e) {
                        var n = vn(ji(e))
                          , i = (t.match(Ri) || []).map(j).sort(function(t, e) {
                            return t - e
                        });
        ...
        methods: {
            load: function(t) {
                ...
                t.some(function(t) {
                    ...
                    return Li(e.$el, qi(t), t.srcset, t.sizes),
                    Ui[e.cacheKey] = qi(t),
                    t
                }, Q),
                this.observer.disconnect())
    ...
    function Li(t, e, n, i) {
        if (Yi(t))
            ...
            !y(t.style.backgroundImage, e) && (He(t, "backgroundImage", "url(" + It(e) + ")"),
            zt(t, Bt("load", !1)))
        }
    }
    ...
    var Gi, Ji, Zi = {
        ...
        update: {
            ...
            write: function(t) {
                ...
                it(this.wrapper, this.attrFill, new Array(t.width).join(t.fill)))
            },
            events: ["resize"]
        }
    }, Qi = {
        ...
        events: [{
            ...
            handler: function(t) {
                var e = Gi && Gi !== this && Gi;
                Gi = this,
                e ? this.stack ? this.prev = e : ((Gi = e).hide().then(this.show),
                t.preventDefault()) : function() {
                    ...
                    Ji = [Mt(document, re, function(t) {
                        ...
                        !Gi || !Gi.bgClose || n || Gi.overlay && !Nt(e, Gi.$el) || Nt(e, Gi.panel) || Gi.hide()
                    }), Mt(document, "keydown", function(t) {
                        27 === t.keyCode && Gi && Gi.escClose && (t.preventDefault(),
                        Gi.hide())
                    })]
                }()
            }
            ...
            self: !0,
            handler: function() {
                Me(document.documentElement, this.clsPage) || (this.scrollbarWidth = sn(window) - sn(document),
                He(document.body, "overflowY", this.scrollbarWidth && this.overlay ? "scroll" : "")),
        ...
        methods: {
            ...
            show: function() {
                var e = this;
                return this.container && this.$el.parentNode !== this.container ? (fe(this.container, this.$el),
                new Rt(function(t) {
        ...
        return function(r, o) {
            return new Rt(function(n, i) {
                return Dt(r, "show hide", function() {
                    ...
                    r._reject = i,
                    a(r, o);
                    var t = Dt(s, "transitionstart", function() {
                        Dt(s, "transitionend transitioncancel", n, !1, function(t) {
                            return t.target === s
                        }),
                        clearTimeout(e)
                    }, !1, function(t) {
    ...
    var nr = {
        install: function(a) {
            a.modal.dialog = function(t, e) {
                ...
                Mt(n.$el, "hidden", function(t) {
                    t.target === t.currentTarget && Rt.resolve(function() {
                        return n.$destroy(!0)
                    })
                }),
                n
        ...
        events: [{
            ...
            self: !0,
            handler: function() {
                Me(this.panel, "uk-margin-auto-vertical") ? Ce(this.$el, "uk-flex") : He(this.$el, "display", "block"),
                on(this.$el)
            }
        }, {
            name: "hidden",
    ...
    var ir = {
      ...
      , rr = {
        ...
        beforeConnect: function() {
            ...
            this.dropbar = t && (at(t, this.$el) || Se("+ .uk-navbar-dropbar", this.$el) || Se("<div></div>")),
            this.dropbar && (Ce(this.dropbar, "uk-navbar-dropbar"),
            "slide" === this.dropbarMode && Ce(this.dropbar, "uk-navbar-dropbar-slide"))
        },
        disconnected: function() {
        ...
        events: [{
            ...
            handler: function(t, e) {
                ...
                "bottom" === i && this.transitionTo(n.offsetHeight + j(He(n, "marginTop")) + j(He(n, "marginBottom")), n)
            }
        }, {
            name: "beforehide",
            filter: function() {
        ...
        methods: {
            ...
            transitionTo: function(t, e) {
                var n = this
                  , i = this.dropbar
                  , r = Et(i) ? on(i) : 0;
                return He(e = r < t && e, "clip", "rect(0," + e.offsetWidth + "px," + r + "px,0)"),
                on(i, r),
                Ue.cancel([e, i]),
                Rt.all([Ue.start(i, {
                    height: t
      ...
      , or = {
        ...
        events: [{
            ...
            self: !0,
            handler: function() {
                "reveal" !== this.mode || Me(this.panel.parentNode, this.clsMode) || (we(this.panel, "<div>"),
                Ce(this.panel.parentNode, this.clsMode)),
                He(document.documentElement, "overflowY", this.overlay ? "hidden" : ""),
                ...
                Ce(this.panel, this.clsSidebarAnimation, "reveal" !== this.mode ? this.clsMode : ""),
                on(document.body),
            ...
            handler: function() {
                ...
                var t = this.getActive();
                ("none" === this.mode || t && t !== this && t !== this.prev) && zt(this.panel, "transitionend")
            }
        }, {
            name: "hidden",
            self: !0,
    ...
    var ar = {
        ...
        update: {
            ...
            write: function(t) {
                ...
                Math.round(e) !== Math.round(n) && zt(this.$el, "resize")
            },
            events: ["resize"]
        }
    }
      ...
      , cr = {
                ...
                zt(this.$el, "beforescroll", [this, e])) {
                    var o = Date.now()
                      ...
                      , a = function() {
                        ...
                        mn(window, t),
                        t !== r ? requestAnimationFrame(a) : zt(n.$el, "scrolled", [n, e])
                    };
                    a()
                }
            }
        ...
        events: {
            click: function(t) {
                t.defaultPrevented || (t.preventDefault(),
                this.scrollTo(It(decodeURIComponent(this.$el.hash)).substr(1)))
            }
        }
    };
    var ur = {
        ...
        update: [{
            write: function() {
                this.hidden && He(_t(this.elements, ":not(." + this.inViewClass + ")"), "visibility", "hidden")
            }
        }, {
            read: function(t) {
                var n = this;
                ...
                this.elements.forEach(function(t) {
                    ...
                    if (!n.show || n.inview || n.queued) {
                        if (!n.show && (n.inview || n.queued) && o.repeat) {
                            ...
                            !n.inview)
                                return;
                            He(t, "visibility", o.hidden ? "hidden" : ""),
                            Ae(t, o.inViewClass),
                            Oe(t, e),
                            zt(t, "outview"),
                            o.$update(t),
                        ...
                        o.delay ? (n.queued = !0,
                        r.promise = (r.promise || Rt.resolve()).then(function() {
                            return !n.inview && new Rt(function(t) {
        ...
        update: [{
            ...
            read: function(o) {
                ...
                this.targets.every(function(t, e) {
                    ...
                    if (!s.overflow && (0 === e && a < n || i && n + t.offsetTop < a))
                        return !1;
                    ...
                    return !(o.active = Se(_t(s.links, '[href="#' + t.id + '"]')))
                })
            },
            write: function(t) {
                var e = t.active;
                ...
                e && zt(this.$el, "active", [e, Ce(this.closest ? xt(e, this.closest) : e, this.cls)])
            },
            events: ["scroll", "resize"]
        }]
    }
      , dr = {
        ...
        computed: {
            ...
            isActive: {
                ...
                set: function(t) {
                    ...
                    zt(this.$el, "active")) : t || Me(this.selTarget, this.clsInactive) || (Ne(this.selTarget, this.clsActive, this.clsInactive),
                    zt(this.$el, "inactive"))
                }
            }
        },
        connected: function() {
            this.placeholder = Se("+ .uk-sticky-placeholder", this.$el) || Se('<div class="uk-sticky-placeholder"></div>'),
            this.isFixed = !1,
            this.isActive = !1
        },
        disconnected: function() {
                ...
                if (!1 !== this.targetOffset && location.hash && 0 < window.pageYOffset) {
                    ...
                    r && xn.read(function() {
                        var t = en(r).top
                          , e = en(i.$el).top
                          , n = i.$el.offsetHeight;
                        i.isFixed && t <= e + n && e <= t + r.offsetHeight && mn(window, t - n - (B(i.targetOffset) ? i.targetOffset : 0) - i.offset)
                    })
                }
            }
        }],
        update: [{
            read: function(t, e) {
                ...
                return this.top = Math.max(j(fr("top", this)), this.topOffset) - this.offset,
                this.bottom = i && i - n,
            ...
            read: function(t) {
                var e = t.scroll;
                return void 0 === e && (e = 0),
                this.width = (Et(this.widthElement) ? this.widthElement : this.$el).offsetWidth,
            ...
            write: function(t, e) {
                ...
                var r = t.dir
                  ...
                  , c = t.visible
                  , u = performance.now();
                if (!((t.lastScroll = a) < 0 || a === s || !c || this.disabled || this.showOnUp && "scroll" !== e || ((300 < u - i || r !== o) && (t.initScroll = a,
                t.initTimestamp = u),
                t.lastDir = r,
                this.showOnUp && Math.abs(t.initScroll - a) <= 30 && Math.abs(s - a) <= 10)))
                    if (this.inactive || a < this.top || this.showOnUp && (a <= this.top || "down" === r || "up" === r && !this.isFixed && a <= this.bottomOffset)) {
                        if (!this.isFixed)
                            return void (Ze.inProgress(this.$el) && a < h && (Ze.cancel(this.$el),
                            this.hide()));
                        this.isFixed = !1,
                        this.animation && a > this.topOffset ? (Ze.cancel(this.$el),
                        Ze.out(this.$el, this.animation).then(function() {
                            return n.hide()
                        }, Q)) : this.hide()
                    } else
                        this.isFixed ? this.update() : this.animation ? (Ze.cancel(this.$el),
                        this.show(),
                        Ze.in(this.$el, this.animation).catch(Q)) : this.show()
            },
            events: ["resize", "scroll"]
        }],
        methods: {
            ...
            update: function() {
                ...
                this.isActive = t,
                Oe(this.$el, this.clsBelow, this.scroll > this.bottomOffset),
    ...
    var pr, mr = {
        ...
        events: [{
            ...
            handler: function(e) {
                e.preventDefault(),
                this.show(V(this.$el.children).filter(function(t) {
        ...
        update: function() {
            ...
            this.swiping && He(this.connects, "touch-action", "pan-y pinch-zoom")
        },
        methods: {
            index: function() {
                return !P(this.connects) && ce(_t(this.connects[0].children, "." + this.cls)[0])
            },
            show: function(t) {
                for (var e, n, i = this, r = this.$el.children, o = r.length, s = this.index(), a = 0 <= s, h = "previous" === t ? -1 : 1, c = ue(t, r, s), u = 0; u < o; u++,
                c = (c + h + o) % o)
                ...
                !n || 0 <= s && Me(n, this.cls) || s === c || (Ae(r, this.cls),
                Ce(n, this.cls),
        ...
        events: [{
            ...
            handler: function(t) {
                var e;
                (xt(t.target, 'a[href="#"], a[href=""]') || (e = xt(t.target, "a[href]")) && (this.cls || !Et(this.target) || e.hash && bt(this.target, e.hash))) && t.preventDefault(),
                this.toggle()
            }
        }],
        update: {
    ...
    var br, yr = "uk-animation-target", xr = {
        props: {
            animation: Number
        },
        data: {
        ...
        methods: {
            animate: function(t) {
                ...
                mn(window, n),
                Rt.all(r.map(function(t, e) {
                    return o[e] && a[e] ? Ue.start(t, a[e], i.animation, "ease") : Rt.resolve()
    ...
    function Er(t, e, n) {
        ...
        (P(n.filter) || ""in n.filter) && (n.filter = {
            "": r || ""
        })) : n.filter = {
            "": r || ""
        }),
    ...
    var Dr = {
        mixins: [{
            ...
            methods: {
                startAutoplay: function() {
                    ...
                    this.interval = setInterval(function() {
                        return (!t.draggable || !Se(":focus", t.$el)) && (!t.pauseOnHover || !bt(t.$el, ":hover")) && !t.stack.length && t.show("next")
                ...
                move: function(t) {
                    ...
                    if (this.unbindMove) {
                        ...
                        if (!(0 == n || this.prevPos === this.pos || !this.dragging && Math.abs(n) < this.threshold)) {
                            ...
                            this.percent = o / a;
                            var h, c = i[r], u = i[s], l = this.index !== s, d = r === s;
                            ...
                            (this.index === r && this.prevIndex !== r || h) && zt(i[this.index], "itemshown", [this]),
                            l && (this.prevIndex = r,
                            this.index = s,
                            d || zt(c, "beforeitemhide", [this]),
                            zt(u, "beforeitemshow", [this])),
                            this._transitioner = this._translate(Math.abs(this.percent), c, !d && u),
                            l && (d || zt(c, "itemhide", [this]),
                            zt(u, "itemshow", [this]))
                        }
                    }
                },
                end: function() {
                    if (Ot(window, "scroll", this.unbindMove),
            ...
            update: {
                write: function() {
                    ...
                    Oe(Te(this.selNavItem, this.$el).concat(this.nav), "uk-hidden", !this.maxIndex),
                    this.updateNav()
                },
                events: ["resize"]
            },
            ...
            methods: {
                updateNav: function() {
                    ...
                    this.navItems.forEach(function(t) {
                        ...
                        Oe(t, "uk-invisible", n.finite && ("previous" === e && 0 === i || "next" === e && i >= n.maxIndex))
                    })
                }
            }
        }],
        ...
        methods: {
            ...
            _getTransitioner: function(t, e, n, i) {
                ...
                new this.Transitioner(z(t) ? this.slides[t] : t,z(e) ? this.slides[e] : e,n * (Zt ? -1 : 1),i)
            }
        }
    };
    function zr(t) {
            ...
            Transitioner: function(o, s, a, t) {
                ...
                return {
                    ...
                    show: function(t, e, n) {
                        ...
                        Rt.all([Ue.start(s, c[1], t, r), Ue.start(o, c[0], t, r)]).then(function() {
                            i.reset(),
                            u.resolve()
                        }, Q),
                        u.promise
      ...
      , Pr = {
        ...
        events: [{
            ...
            handler: function(t, r) {
                ...
                if (this.setItem(r, "<span uk-spinner></span>"),
                e)
                    if ("image" === n || e.match(/\.(jp(e)?g|png|gif|svg|webp)($|\?)/i))
                        Gt(e).then(function(t) {
                        ...
                        var h = o[2]
                          , c = function(t, e) {
                            ...
                            void 0 === e && (e = 450),
                            s.setItem(r, Hr("https://www.youtube" + (o[1] || "") + ".com/embed/" + h, t, e, s.videoAutoplay))
                        };
                        ...
                        (o = e.match(/(\/\/.*?)vimeo\.[a-z]+\/([0-9]+).*?/)) && Kt("https://vimeo.com/api/oembed.json?maxwidth=1920&url=" + encodeURI(e), {
                            responseType: "json",
                            withCredentials: !1
                        }).then(function(t) {
                            var e = t.response
    ...
    function jr(n) {
        return ["href", "caption", "type", "poster", "alt"].reduce(function(t, e) {
            return t["href" === e ? "source" : e] = st(n, e),
            t
        }, {})
    }
    var Wr = {}
      , Vr = {
        ...
        connected: function() {
            var t, e = this, n = j(He(this.$el, this.marginProp));
        ...
        events: (Lr = {
            click: function(t) {
                xt(t.target, 'a[href="#"],a[href=""]') && t.preventDefault(),
                this.close()
            }
        },
        Lr[oe] = function() {
        ...
        methods: {
            close: function(t) {
                function e() {
                    zt(n.$el, "close", [n]),
                    ve(n.$el),
                    Wr[n.pos].children.length || He(Wr[n.pos], "display", "none")
                }
                var n = this;
                this.timer && clearTimeout(this.timer),
        ...
        computed: {
            props: function(m, g) {
                ...
                return Rr.reduce(function(t, e) {
                    if (H(m[e]))
                        return t;
                    var n, i, r, o = e.match(/color/i), s = o || "opacity" === e, a = m[e].slice(0);
                    s && He(g, e, ""),
                    a.length < 2 && a.unshift(("scale" === e ? 1 : s ? He(g, e) : 0) || 0);
                    var h = function(t) {
                        return t.reduce(function(t, e) {
                    ...
                    if (o) {
                        ...
                        i = He(g, "backgroundPosition").split(" ")["x" === e[2] ? 0 : 1],
                        v.covers) {
                    ...
                    var n = d[e]
                      ...
                      , s = function(t, e, n) {
                        ...
                        var i = qr(t, e)
                          ...
                          , o = i[1]
                          , s = i[2];
                        return (z(r) ? r + Math.abs(r - o) * s * (r < o ? 1 : -1) : +o).toFixed(n)
                    }(i, l);
                    switch (e) {
                    case "x":
                    case "y":
            ...
            Transitioner: function(r, i, o, t) {
                ...
                return {
                    ...
                    translate: function(t) {
                        ...
                        He(a, "transform", _r(Z(e - e * t - c, -Jr(a), Qr(a).width) * (Zt ? -1 : 1), "px")),
        ...
        computed: {
            ...
            sets: function(t) {
                ...
                return !P(e = e && this.slides.reduce(function(t, e, n) {
                    var i = Qr(e).width;
                    if (a < c + i && (!o.center && n > o.maxIndex && (n = o.maxIndex),
                    !y(t, n))) {
                        var r = o.slides[n + 1];
                        o.center && r && i < h - Qr(r).width / 2 ? h -= i : (h = s,
                        t.push(n),
        ...
        update: {
            write: function() {
                ...
                Te("[" + this.attrItem + "],[data-" + this.attrItem + "]", this.$el).forEach(function(t) {
                    var e = st(t, n.attrItem);
                    n.maxIndex && Oe(t, "uk-hidden", B(e) && (n.sets && !y(n.sets, j(e)) || e > n.maxIndex))
                }),
        ...
        events: {
            beforeitemshow: function(t) {
                ...
                if (!this.dragging && 1 < e) {
                    ...
                    this.duration = zr(this.avgWidth / this.velocity) * (Qr(this.dir < 0 || !this.slides[this.prevIndex] ? this.slides[this.index] : this.slides[this.prevIndex]).width / this.avgWidth),
                    this.reorder()
            },
            itemshow: function() {
                H(this.prevIndex) || Ce(this._getTransitioner().getItemIn(), this.clsActive)
            },
            itemshown: function() {
                var e = this
      ...
      , io = {
        ...
        events: [{
            ...
            handler: function(t) {
                ...
                Ue.start(this.$el, this.getCss(ro(e) ? .5 : 0 < s ? 1 : 0), r, o).catch(Q)
            }
        }, {
    ...
    var so, ao = X({}, Cr, {
        ...
        update: {
            write: function() {
                if (this.clsEmpty && Oe(this.$el, this.clsEmpty, P(this.$el.children)),
                He(this.handle ? Te(this.handle, this.$el) : this.$el.children, {
                    touchAction: "none",
                    userSelect: "none"
                }),
                this.drag) {
                    var t = en(window)
                      ...
                      , n = t.bottom;
                    en(this.drag, {
                        top: Z(this.pos.y + this.origin.top, 0, n - this.drag.offsetHeight),
                        left: Z(this.pos.x + this.origin.left, 0, e - this.drag.offsetWidth)
                    }),
                    function s(t) {
                        var a = t.x;
                        var h = t.y;
                        clearTimeout(so);
                        (e = document.elementFromPoint(a - window.pageXOffset, h - window.pageYOffset),
                        n = fo(),
                        function(t, e) {
                            var n = [];
                            for (; e(t) && n.unshift(t),
                            ...
                            return t === n || lo.test(He(t, "overflow"))
                        })).some(function(t) {
                            var e = t.scrollTop
                              , n = t.scrollHeight;
                            fo() === t && (t = window,
                            ...
                            var i = en(t)
                              , r = i.top
                              , o = i.bottom;
                            if (r < h && h < r + 30 ? e -= 5 : h < o && o - 20 < h && (e += 5),
                            0 < e && e < n)
        ...
        methods: {
            init: function(t) {
                ...
                !r || i || 0 < n || At(e) || Nt(e, "." + this.clsNoDrag) || this.handle && !Nt(e, this.handle) || (t.preventDefault(),
                this.touched = [this],
                this.placeholder = r,
                this.origin = X({
                    target: e,
            ...
            start: function(t) {
                this.drag = fe(this.$container, this.placeholder.outerHTML.replace(/^<li/i, "<div").replace(/li>$/i, "div>")),
                He(this.drag, X({
                    boxSizing: "border-box",
                    width: this.placeholder.offsetWidth,
                    height: this.placeholder.offsetHeight,
                    overflow: "hidden"
                }, He(this.placeholder, ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom"]))),
                it(this.drag, "uk-no-boot", ""),
                Ce(this.drag, this.clsDrag, this.clsCustom),
                on(this.drag.firstElementChild, on(this.placeholder.firstElementChild));
            ...
            move: function(t) {
                if (this.drag) {
                    ...
                    var e = "mousemove" === t.type ? t.target : document.elementFromPoint(this.pos.x - window.pageXOffset, this.pos.y - window.pageYOffset)
                      ...
                      , r = n !== i;
                    if (n && !Nt(e, this.placeholder) && (!r || n.group && n.group === i.group)) {
                ...
                if (Ot(document, ie, this.move),
                Ot(document, re, this.end),
                Ot(window, "scroll", this.scroll),
                this.drag) {
                    clearTimeout(so);
                    var e = this.getSortable(this.placeholder);
                    this === e ? this.origin.index !== ce(this.placeholder) && zt(this.$el, "moved", [this, this.placeholder]) : (zt(e.$el, "added", [e, this.placeholder]),
            ...
            remove: function(t) {
                Nt(t, this.$el) && (He(this.handle ? Te(this.handle, t) : t, {
                    touchAction: "",
                    userSelect: ""
                }),
    ...
    var po, mo, go, vo = [], wo = {
        ...
        methods: {
            show: function() {
                var e = this;
                this.isActive() || (vo.forEach(function(t) {
                    return t.hide()
                }),
                vo.push(this),
            ...
            hide: function() {
                this.isActive() && !bt(this.$el, "input:focus") && (vo.splice(vo.indexOf(this), 1),
                clearTimeout(this.showTimer),
            ...
            _show: function() {
                this.tooltip = fe(this.container, '<div class="' + this.clsPos + '" aria-expanded="true" aria-hidden> <div class="' + this.clsPos + '-inner">' + this.title + "</div> </div>"),
                this.positionAt(this.tooltip, this.$el),
                this.origin = "y" === this.getAxis() ? dn(this.dir) + "-" + this.align : this.align + "-" + dn(this.dir),
        ...
        events: {
            change: function(t) {
                bt(t.target, 'input[type="file"]') && (t.preventDefault(),
            ...
            drop: function(t) {
                ...
                e && e.files && (Ae(this.$el, this.clsDragover),
                this.upload(e.files))
            },
                      ...
                      , o = function(t) {
                        ...
                        Kt(i.url, {
                            ...
                            beforeSend: function(t) {
                                var e = t.xhr;
                                e.upload && Mt(e.upload, "progress", i.progress),
    ...
    return Hn.component("countdown", wr),
    ...
    mo = (po = Hn).connect,
    go = po.disconnect,
    "MutationObserver"in window && (document.body ? xn.read(ko) : new MutationObserver(function() {
